...
struct TripInfoView: View {
        ...
        if hasEvents {
          HStack(spacing: 4) {
            ...
            if trip.drowsyEventCount > 0 {
              EventPill(icon: "moon.fill", count: trip.drowsyEventCount, color: .yellow)
            }
            ...
            if trip.excessiveBlinkingEventCount > 0 {
              EventPill(icon: "eye", count: trip.excessiveBlinkingEventCount, color: .teal)
            }
            if trip.unstableEyesEventCount > 0 {
              EventPill(
                icon: "eye.trianglebadge.exclamationmark", count: trip.unstableEyesEventCount,
                color: .red)
            }
  ...
  private var hasEvents: Bool {
    trip.speedingEventCount > 0
      ...
      || trip.drowsyEventCount > 0
      || trip.drinkingEventCount > 0
      || trip.excessiveBlinkingEventCount > 0
      || trip.unstableEyesEventCount > 0
      || trip.maxSpeedMph > 0
  }
}
